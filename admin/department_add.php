                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title"> Add Departments <small class="ml-10">Home Departments Add</small></h4>
                                    <p class="sub-title">Departments Add</p>
                                </div>
                                <!-- /.col-md-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Departments Add</li>
            						</ul>
                                </div>
                                <!-- /.col-md-6 -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title"> Add Complete Detail Of Departments</h3>
							</div>
...
<div class="form-group left-icon">
                                                		<label for="name2">Name Of Department</label>
						...
						$enter_time=date("h:i:s A");
												 ...
												 $name=$_POST["name"];
												 $query="insert into department set name='$name',date='$enter_date',time='$enter_time'";
