                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title">Home Description <small class="ml-10">Home- Home Description</small></h4>
                                    <p class="sub-title">Home Description</p>
                                </div>
                                <!-- /.col-md-6 -->
                                  </div>
                            <!-- /.row -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title">Home Description</h3>
							</div>
...
?>
                       ...
                       <center><label for="text1" class="control-label col-lg-2">Previous </label> <img style="width:75px; height:75px;" class="media-object img-thumbnail user-img" alt="User Picture" src="images/<?php echo $read['image'];?>"/>
								   ...
								   <h4><i class="fa fa-link"></i> Image Upload</h4>
                                        ...
                                        <div class="fallback">
                                            <input required name="img" type="file"  /> </div>
                                  
									</br>
                                    </div>
									
									<div class="form-group left-icon">
                                                		<label for="name2">Title  Of Home Description</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input type="text" value="<?php echo $read['title'];?>" name="title" class="form-control" id="name2" placeholder="Title Of Home Description">
                                                	</div>
												
                                    <div class="form-group">
                                                		<label for="name2">Description Of Home</label>
                                                        <textarea required type="text"  name="description" class="form-control" id="home_des" placeholder="Description Of Home"><?php echo $read['description']; ?></textarea>
                                                	</div>	
...
$description=$_POST['description'];				
		$query1="update   home_des set image='$new_img',title='$title',description='$description'";
