                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title"> Add Courses <small class="ml-10">Home Courses Add</small></h4>
                                    <p class="sub-title">Courses Add</p>
                                </div>
                                <!-- /.col-md-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Courses Add</li>
            						</ul>
                                </div>
                                <!-- /.col-md-6 -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title"> Add Complete Detail Of Courses</h3>
							</div>
...
<div class="form-group left-icon">
                                                		<label for="name2">Name Of Courses</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input required type="text" class="form-control" name="name" id="name2" placeholder="Name Of Department">
                                                	</div>
                                    <hr>
						...
						$enter_time=date("h:i:s A");
												  ...
												  $query="insert into  courses set name='$name',date='$enter_date',time='$enter_time'";
