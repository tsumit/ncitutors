...
<html lang="en">
    <head>
        ...
        <title>Recent Event/News Edit</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title">Edit Recent Event/News <small class="ml-10">Home Recent Event/News Edit</small></h4>
                                    <p class="sub-title">Recent Event/News Edit</p>
                                </div>
                                <!-- /.col-md-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Recent Event/News Edit</li>
            						</ul>
                                </div>
                                <!-- /.col-md-6 -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title">Edit Complete Detail Of Recent Event/News</h3>
							</div>
								  ...
								  <div class="col-md-12" style="min-height: 900px;">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
												 ...
												 <?php
$q="select * from  event_news where id='$x'";
$query=mysql_query($q);
...
?>
                       ...
                       <center><label for="text1" class="control-label col-lg-2">Previous </label> <img style="width:75px; height:75px;" class="media-object img-thumbnail user-img" alt="User Picture" src="images/<?php echo $read['image'];?>"/>
                                    ...
                                    <h4><i class="fa fa-link"></i> Image Upload</h4>
                                        ...
                                        <div class="fallback ropzone">
                                            <input required type="file" name="image" /> </div>
                                </div>
									</br>
									<div class="form-group left-icon">
                                                		<label for="name2">Title Of Recent Event/News</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input required type="text" value="<?php echo $read['title'];?>" class="form-control" name="title" id="name2" placeholder="Title Of Recent Event/News">
                                                	</div>
													...
													<textarea name="description" id="des"><?php echo $read['description'];?></textarea>

                                               <div class="form-group left-icon">
                                                		<label for="name2">Posted In</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input required type="text" value="<?php echo $read['posted_in'];?>" class="form-control" name="posted_in" id="name2" placeholder="Hobbies">
                                                	</div>
													<div class="form-group left-icon">
                                                		<label for="name2">Tags</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input required type="text" value="<?php echo $read['tags'];?>" class="form-control" name="tags" id="name2" placeholder="educate">
                                                	</div>
					 ...
					 $title=$_POST['title'];
												 ...
												 $description=$_POST["description"];
												  $query="update event_news set image='$new_img',title='$title',description='$description',posted_in='$posted_in',tags='$tags' where id='$x'";
