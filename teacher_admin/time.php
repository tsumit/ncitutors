...
<html lang="en">
    <head>
        ...
        <title>Set Free Time Slot</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title">Set Free Time Slot<small class="ml-10">Home Set Free Time Slot</small></h4>
                                    <p class="sub-title">Set Free Time Slot</p>
                                </div>
                                <!-- /.col-md-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Set Free Time Slot</li>
            						</ul>
                                </div>
                                <!-- /.col-md-6 -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title">Complete Detail Of Set Free Time Slot</h3>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
							<a href="time_add.php"  class="btn btn-lg btn-rounded btn-danger pull-right adjust"> Add Set Free Time Slot</a>
							</div>
							</div>
</div>                                  
...
<div id="table-scroll">
									...
									$q="select * from time_add where teacher_id='$teacher_id' ";
									...
									while($read=mysql_fetch_array($exe))
									{
										...
										?> 
											...
											<a href="time_edit.php?x=<?php echo $read["id"];?>" onclick="return edit()" title="Edit"><i class="fa fa-edit"></i></a>
											</li>
											<li class="list-item-secnd-manage">
											<a href="time_delete.php?x=<?php echo $read["id"];?>" onclick="return del()" title="Delete"><i class="fa fa-trash"></i></a>
											</li>
											</ul>	
															</td>
                                                        </tr>
